...
frenette_maatarka_output <- lst(input_veg = frenette_veg, 
                     ...
                     study_name = "Frenette_maatarka")

save(frenette_maatarka_output,
 file = "data/processed/frenette_maatarka_prep.RData")
