...
frenette_lamjalil_output <- lst(input_veg = frenette_veg, 
                     ...
                     study_name = "Frenette_lamjalil")

save(frenette_lamjalil_output,
 file = "data/processed/frenette_lamjalil_prep.RData")
