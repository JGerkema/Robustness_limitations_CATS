...
liane_finland1_output <- lst(input_veg = liane_veg, 
                     ...
                     study_name = "Liane_finland_1")

save(liane_finland1_output,
 file = "data/processed/liane_finland_1_prep.RData")
