...
load("~/0. PhD/0. Chapter I/data/processed/aiello1992_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/aiello2011_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/bagaria_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/bergholz_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/buzzard_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/castro_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/chalmandrier_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/choler_calculations.RData")
#load("~/0. PhD/0. Chapter I/data/processed/cornwell_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/eallonardo_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/frenette2009_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/frenette2010_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/jaschke_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/kembel_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/liane_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/marteinsdottir_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/raevel_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/riva_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/rolhauser_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/kassaw_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/gonzalez_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/standen_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/makelele_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/jager_calculations.RData")
load("~/0. PhD/0. Chapter I/data/processed/osuri_calculations.RData")
...
study_lwc <- c("aiello1992", "aiello2011", "bagaria",  "buzzard", "castro", "chalmandrier", "choler", "eallonardo", "frenette2009", "frenette2010", "gonzalez", "jager", "jäschke", "kassaw", "kembel", "liane", "makelele", "marteinsdottir", "osuri", "raevel", "riva", "rolhauser", "standen"
)
...
Oké ik moet even nadenken over de workflow. Ik heb de taxonomische informatie van alle soorten nodig
per 
