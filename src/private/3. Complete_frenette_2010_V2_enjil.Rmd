...
frenette2010_veg_info <- read_excel("data/raw/CESTES/Plant_data/Frenette_meta.xlsx") %>%
    select(Sites, SiteReg) %>%
    filter(SiteReg == "Enjil")
...
frenette_enjil_output <- lst(input_veg = frenette_veg, 
                     ...
                     study_name = "Frenette_enjil")

save(frenette_enjil_output,
 file = "data/processed/frenette_enjil_prep.RData")
