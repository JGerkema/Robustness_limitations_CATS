...
frenette_tirnest_output <- lst(input_veg = frenette_veg, 
                     ...
                     study_name = "Frenette_tirnest")

save(frenette_tirnest_output,
 file = "data/processed/frenette_tirnest_prep.RData")
